						...
						<?php foreach($pages as $key => $_page){ ?>
							<div class="menu-div">
								<div class="m-left">
    								...
    								<div class="m_img">
    									<img src="<?php echo FATHER_BASE.'files/social_media/img/100/'.$_page['social_media_image'];?>" 
    									width="50"/>
    								</div>
    								<div class="r_zone">
								...
								<div class="conf">
								    ...
								    <a class="configure" href="<?php echo UPDATE_SOCIAL_MEDIA.$_page['id'];?>" class="btn btn-xs btn-info">
