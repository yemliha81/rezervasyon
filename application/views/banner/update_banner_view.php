    ...
    <div class="page-content">
        ...
        <div class="main-content m-t-20">
            <div class="">
							...
							<div class="top-ttl">
    							<div class="r_ttl">
    								<div class="ttl">Slayt Güncelle</div>
    								<div>Lütfen Slayt bilgilerini giriniz</div>
    							</div>
							...
							<form action="<?php echo UPDATE_BANNER_POST;?>" method="post" enctype="multipart/form-data">
								<div class="m-b-20 menu-form">
									<div>
    										...
    										<input class="input_style dropify" type="file" name="banner_image"  data-default-file="<?php echo FATHER_BASE.'files/banner/img/400/'.$page['banner_image'];?>"/>
									...
									<div class="menu-form-2">
                                        ...
                                        <input class="input_style lng en" type="text" name="url" placeholder="Slayt Linki* (EN)" required   value="<?php echo $page['url'];?>"/>
    									</div>
    									<div class="">
