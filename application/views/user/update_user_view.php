    ...
    <div class="page-content">
        ...
        <div class="main-content m-t-20">
            <div class="">
                <div class="top-ttl">
                    <div class="r_ttl">
                        <div class="ttl">Kullanıcı Güncelle</div>
                        <div>Lütfen kullanıcı bilgilerini giriniz</div>
                    </div>
                </div>
                <form action="<?php echo UPDATE_USER_POST;?>" method="post" enctype="multipart/form-data">
                    <div class="grid-5">
                        <div>isim :</div>
                        <div class="">
                            <input class="input_style" type="text" name="full_name" required   value="<?php echo $user['full_name'];?>"/>
                        </div>
                        <div>Kullanıcı Adı :</div>
                        <div class="">
                            <input class="input_style" type="text" name="username"  required   value="<?php echo $user['username'];?>"/>
                        </div>
                        <div>Şifre :</div>
                        <div class="">
                        ...
                        <div class="">
                            <select name="role" class="input_style">
                                <option value="1" <?php echo ($user['role'] == '1') ? 'selected' : '';?>>Yönetici</option>
                                <option value="2" <?php echo ($user['role'] == '2') ? 'selected' : '';?>>Güvenlik</option>
                            </select>
                        </div>
                    </div>
